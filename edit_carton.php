...
FU.id_fuente,
PP.id_carton AS id,
PP.fecha, PP.imagen, PP.autor, 
FU.nombre as fuente
FROM
carton AS PP,
fuente AS FU
WHERE 1=1 AND PP.id_fuente = FU.id_fuente
AND PP.id_carton = ".$_GET['id_pp'];
        ...
        <table width="1000" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr valign="top">
                        ...
                        <tr valign="middle">
                          ...
                          <td width="533" height="25" class="label2">Prensa --&gt; Cartones --&gt;<span class="label4"> Editar Carton</span></td>
                        ...
                        <tr>
                            <td valign="top"><form action="action_add_carton.php" method="post" enctype="multipart/form-data" name="form_insert" id="form_insert">
                              <table width="825" border="0">
                                <tr>
                                  <td width="93">&nbsp;</td>
                                  <td width="154" class="label2">Editar Carton</td>
                                ...
                                <tr>
                                  ...
                                  <td><label>
                                  <input name="titulo" type="text" class="combo3" id="titulo" value="<?php echo $row_query['autor'] ?>" />
                                  </label></td>
                                </tr>
                                <tr>
                                  <td>&nbsp;</td>
                                  ...
                                  <td><label>
                                  <input name="autor" type="text" class="combo3" id="autor" value="<?php echo $row_query['autor'] ?>" />
                                  </label></td>
                                </tr>
                                <tr>
                                  <td>&nbsp;</td>
