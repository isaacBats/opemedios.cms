        ...
        <table width="1000" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr valign="top">
                        ...
                        <tr valign="middle">
                          ...
                          <td width="533" height="25" class="label2">Prensa --&gt; Portadas Financieras --&gt;<span class="label4"> Agregar</span></td>
...
<table width="1000" border="0">
                        ...
                        <tr>
                            <td valign="top"></td>
                            <td valign="top"><form action="action_add_portada_financiera.php" method="post" enctype="multipart/form-data" name="form_insert" id="form_insert">
                              <table width="825" border="0">
                                <tr>
                                  <td width="96">&nbsp;</td>
                                  <td width="157" class="label2"><span class="label2">Agregar Portadas Financieras</span></td>
                                ...
                                <tr>
                                  ...
                                  <td valign="middle">
                                  <input colspan="4"  name="imagen" type="file" id="imagen" size = "45" />
