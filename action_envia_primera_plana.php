<?php
/* 
 * Envia las primeras planas por correo electronico
 */
...
{
    $base->close();
    header("Location: envio_primerasplanas.php");
    exit();
}
else // SI hay cuentas
{
    ...
    //leemos primeras planas y creamos los thumbs
    ...
    $headers .= "Return-Path: <prensa@operamedios.com.mx>\n";
    $headers .= "Content-type: text/html; charset=utf-8\n"; //iso-8859-1
    $headers .= "From: Prensa OPEMEDIOS <prensa@operamedios.com.mx>";

    $subject = "Primeras Planas del ".getFecha_larga($fecha);
    ...
    $message = '<html>
                    ...
                    <tr bgcolor="#FFFFFF">
                            ...
                            <img src="http://www.operamedios.com.mx/html/images/logo.gif" alt=""><br></td>
                            <td align="right" valign="top">
                            <img src="http://www.operamedios.com.mx/html/images/top.gif" alt=""><br>
                            <b><font face="Tahoma" size="2">Primeras Planas del d&iacute;a '.getFecha_larga($fecha).'</font></b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
    ...
    $base->execute_query($query);
        while($row_query = $base->get_row_assoc()) {
            ...
            $message.='<td bgcolor="#FFEDE1"><font face="Tahoma" size="2">
                       <div align="center"><br>
                       <a href="http://sistema.operamedios.com.mx/data/primera_plana/'.$row_query['imagen'].'"><img src="http://sistema.operamedios.com.mx/data/thumbs/'.$row_query['imagen'].'_mailtn.jpg" alt="" border="1"></a><br><br>
                       <b>'.$row_query['fuente'].'</b><br></div>
                    </td>
                   ';
            $columna ++;
            if($columna == 5) {
                $message.= '</tr>
                            ...
                            <tr>
                                 <td colspan="6">
                                 <img src="http://www.operamedios.com.mx/intranet/images/trans.gif" width="1" height="15" alt=""><br>
        ...
        $message.= '</table><br><br>
                    ...
                    contacto@operamedios.com.mx </font><br>

                    </td>
                    </tr>
                    <tr bgcolor="#FFFFFF">
                            <td colspan="2"><img src="http://www.operamedios.com.mx/html/images/pie.gif" alt=""><br></td>
                    </tr>
                    </table><br>
...
$base->free_result();
$base->close();
header("Location: envio_primerasplanas.php?&mensaje=El envío se realizo exitosamente");
exit();
