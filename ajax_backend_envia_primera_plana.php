        ...
        case "muestra_cuentas":
            ...
            else // si hay cuentas
            {
                ...
                while($row_cuenta = $base->get_row_assoc())
                {
                    ...
                    $new_back[] .= '<form id="form1" name="form1" method="post" action="action_envia_primera_plana.php">';
                   
                    $new_back[] .= '<br />
                                    <span class="label2">Seleccionar cuentas a las que se enviarán las Primeras Planas:</span><br /><br />
