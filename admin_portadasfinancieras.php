...
$limite = paginacion_init($_GET["pagina"],$registros);
    ...
    $query = "SELECT * FROM portada_financiera where fecha = '".$_GET['txt_buscar']."'";
    $base->execute_query($query);
    $num_row = $base->num_rows();
//-----------------------------------------------------------------------
$query = "SELECT
            PP.id_portada_financiera AS id,
            PP.fecha,
            PP.imagen,
            FU.nombre as fuente
          FROM
            portada_financiera AS PP,
            fuente AS FU
          WHERE 1=1
        ...
        <table width="1000" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr valign="top">
                        ...
                        <tr valign="middle">
                          ...
                          <td width="533" height="25" class="label2">Prensa --&gt; Portadas Financieras --&gt;<span class="label4"> Administrar Portadas Financieras</span></td>
                  ...
                  <form id="form_buscar" name="form_buscar" method="get" action="admin_portadasfinancieras.php">         
...
<tr>
                                            ...
                                            <tr>
                                              <td width="18">&nbsp;</td>
                                              <td colspan="2" class="label2">Ver Portadas Financieras por Fecha:</td>
                                              <td width="542">&nbsp;</td>
                                            </tr>
                                            <tr>
                                              <td>&nbsp;</td>
                                              ...
                                              <td><input name="btnbuscar" type="submit" id="btnbuscar" value="Ver Portadas Financieras" /></td>
                                            </tr>
                                          </table>
                  </form>
                          ...
                          <tr class="header2">
                            ...
                            <td width="62">&nbsp;</td>
                                    ...
                                    while($row_query = $base->get_row_assoc())
                                    {
                                            ...
                                            echo'<td align="center"><a href="enviar_portadafinanciera.php?id_pp='.$row_query['id'].'">Enviar a Cliente</a></td>';
                                            echo'<td align="center"><a href="edit_portadasfinancieras.php?id_pp='.$row_query['id'].'">Editar Plana</a></td>';
                                            echo'</tr>';
                                        }
                                    ?>
                              </table> 
