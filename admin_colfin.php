...
$limite = paginacion_init($_GET["pagina"],$registros);
    ...
    $query = "SELECT * FROM columna_financiera where fecha = '".$_GET['txt_buscar']."'";
    $base->execute_query($query);
    $num_row = $base->num_rows();
	
 $query = "SELECT
            PP.id_columna_financiera AS id,
            PP.autor,
            PP.titulo,
            PP.fecha,
            PP.imagen_jpg AS imagen,
            PP.archivo_pdf AS archivo,
            FU.nombre as fuente
          FROM
            columna_financiera AS PP,
            fuente AS FU
          WHERE 1=1
...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Administrar Columnas Financieras</title>
        <style type="text/css">
            <!--
            body {
        ...
        <table width="1000" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr valign="top">
                        ...
                        <tr valign="middle">
                          ...
                          <td width="533" height="25" class="label2">Prensa --&gt; Columnas Financieras--&gt;<span class="label4"> Administrar </span></td>
                  ...
                  <form id="form_buscar" name="form_buscar" method="get" action="admin_colfin.php">         
...
<tr>
                                            ...
                                            <tr>
                                              <td width="18">&nbsp;</td>
                                              <td colspan="2" class="label2">Ver Columnas Financieras por Fecha:</td>
                                              <td width="542">&nbsp;</td>
                                            </tr>
                                            <tr>
                                              <td>&nbsp;</td>
                                              ...
                                              <td><input name="btnbuscar" type="submit" id="btnbuscar" value="Ver Columna" /></td>
                                            </tr>
                                          </table>
                  </form>
                          ...
                          <tr class="header2">
                            ...
                            <td width="124">&nbsp;</td>
                                    ...
                                    while($row_query = $base->get_row_assoc())
                                    {
                                            ...
                                            echo'<td align="center"><a href="edit_colfin.php?id_pp='.$row_query['id'].'">Editar Columna</a></td>';
                                            echo'</tr>';
                                        }
                                    ?>
                              </table> 
