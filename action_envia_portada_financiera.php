...
{
    $base->close();
    header("Location: envio_portadasfinancieras.php");
    exit();
}
else // SI hay cuentas
{
    ...
    $subject = "Portadas Financieras del ".getFecha_larga($fecha);
    ...
    $message = '<html>
                    ...
                    <tr bgcolor="#FFFFFF">
                            ...
                            <b><font face="Tahoma" size="2">Portadas Financieras del d&iacute;a '.getFecha_larga($fecha).'</font></b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
    ...
    $base->execute_query($query);
        while($row_query = $base->get_row_assoc()) {
            ...
            $message.='<td bgcolor="#FFEDE1"><font face="Tahoma" size="2">
                       <div align="center"><br>
                       <a href="http://sistema.operamedios.com.mx/data/financiero/'.$row_query['imagen'].'"><img src="http://sistema.operamedios.com.mx/data/thumbs/'.$row_query['imagen'].'_mailtn.jpg" alt="" border="1"></a><br><br>
...
$base->free_result();
$base->close();
header("Location: envio_portadasfinancieras.php?&mensaje=El envío se realizo exitosamente");
exit();
