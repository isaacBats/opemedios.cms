...
<table width="1000" border="0">
                        ...
                        <tr>
                            <td valign="top"><form id="form_buscar" name="form_buscar" method="get" action="reporte_noticia_cliente.php">
                          ...
                          <tr class="header2">
                            ...
                            <td width="62">&nbsp;</td>
                                    ...
                                    while($row_query = $base->get_row_assoc())
                                    {
                                            echo'<tr class="label1"><form name="reporte" action="busqueda_avanzada_reportes.php" method="POST">';
