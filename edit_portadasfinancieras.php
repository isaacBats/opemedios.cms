...
AND PP.id_portada_financiera = ".$_GET['id_pp'];
        ...
        <table width="1000" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr valign="top">
                        ...
                        <tr valign="middle">
                          ...
                          <td width="533" height="25" class="label2">Prensa --&gt; Portadas Financieras --&gt;<span class="label4"> Editar Portada Financiera</span></td>
                        ...
                        <tr>
                            ...
                            <td valign="top"><form action="action_add_primera_plana.php" method="post" enctype="multipart/form-data" name="form_insert" id="form_insert">
                              <table width="825" border="0">
                                <tr>
                                  <td width="93">&nbsp;</td>
                                  <td width="154" class="label2"><span class="label2">Editar Portada Financiera</span></td>
                                  <td width="458"><div align="right"></div></td>
                            <?php   echo   '<td width="92" rowspan="5"><img height="200" width="200" src="data/financiero/'.$row_query['imagen'].'"></td>'  ?>
                                </tr>
                                <tr>
                                  <td>&nbsp;</td>
                                  <td class="label2">&nbsp;</td>
                                ...
                                <tr>
                                  ...
                                  <td class="label3">&nbsp;</td>
                                  <td valign="middle">&nbsp;</td>
                                  <td height="22" class="label3">imagen actual</td>
                                </tr>
                                <tr>
                                  <td>&nbsp;</td>
                                  <td>&nbsp; </td>
