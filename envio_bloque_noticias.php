        ...
        <table width="1000" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr valign="top">
                        ...
                        <tr valign="middle">
                          ...
                          <td width="533" height="25" class="label2"> Noticias  --&gt;<span class="label4"> Envio de Resumen de Noticias</span></td>
...
<table width="1000" border="0">
                        ...
                        <tr>
                            <td valign="top"><form id="form_buscar" name="form_buscar" method="get" action="envio_bloque_noticias.php">
                          ...
                          <tr class="header2">
                            ...
                            <td width="62">&nbsp;</td>
                                    ...
                                    while($row_query = $base->get_row_assoc())
                                    {
                                            echo'<tr class="label1"><form name="reporte" action="envio_bloque_noticias_parametros.php" method="POST">';
					    ...
					    echo'<td><div align="center">'.$row_query['giro'].'</div></td>';
                                           ...
                                           // echo'<td><div align="center"><script>DateInput("fecha_fin", true, "YYYY-MM-DD") </script></div></td>';
                                            echo'<td align="center"><input type="submit" value="Siguiente" name="Siguiente" /></td>';
