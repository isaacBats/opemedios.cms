...
$base->execute_query("SELECT * FROM fuente_per WHERE id_fuente =".$_GET['id_fuente']);
...
$fuente = new FuenteExtra($datos,3);
}
else
{
//hacemos consulta para la creacion del objeto fuente usando como atributo la variable GET id_fuente
$base->execute_query("SELECT * FROM fuente WHERE id_fuente =".$_GET['id_fuente']);
$datos_fuente1 = $base->get_row_assoc();
$base->execute_query("SELECT * FROM fuente_rev WHERE id_fuente =".$_GET['id_fuente']);
$datos_fuente2 = $base->get_row_assoc();

$datos = $datos_fuente1 + $datos_fuente2;

//creamos el objeto FuenteTV con los datos que nos regrese la consulta
$fuente = new FuenteExtra($datos,4);
}
          ...
          <tr valign="top">
                        ...
                        <tr valign="middle">
                          ...
                          <td width="533" height="25" class="label2">Fuentes --&gt; Administrar Fuentes --&gt; <span class="label4">Editar Fuente de 
                            <?php if($fuente->get_id_tipo_fuente()==3){echo "Periódico";}else{echo "Revista";}?>
                          </span></td>
...
<table width="1000" border="0">
                        ...
                        <tr>
                            ...
                            <td valign="top"><form id="form_update" name="form_update" method="post" action="action_edit_fuente_prensa.php">
                                    <table width="825" border="0">
                                        ...
                                        <tr>
                                            <td>&nbsp;</td>
                                            <td height="28" class="label3">Tiraje:</td>
                                            <td><label>
                                              <input name="tiraje" type="text" class="textbox1" id="tiraje" value="<?php echo $fuente->get_tiraje();?>" />
                                            </label></td>
                                          <td>&nbsp;</td>
                                        </tr>
