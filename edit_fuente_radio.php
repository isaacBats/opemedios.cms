...
$base->execute_query("SELECT * FROM fuente_rad WHERE id_fuente =".$_GET['id_fuente']);
        ...
        <table width="1000" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr valign="top">
                        ...
                        <tr valign="middle">
                          ...
                          <td width="533" height="25" class="label2">Fuentes --&gt; Administrar Fuentes --&gt; <span class="label4">Editar Fuente de Radio</span></td>
...
<table width="1000" border="0">
                        ...
                        <tr>
                            ...
                            <td valign="top"><form id="form_update" name="form_update" method="post" action="action_edit_fuente_radio.php">
                                    <table width="825" border="0">
                                        ...
                                        <tr>
                                            <td>&nbsp;</td>
                                            <td height="28" class="label3">Estación:</td>
                                            <td><label>
                                              <input name="estacion" type="text" class="textbox1" id="estacion" value="<?php echo $fuente->get_estacion();?>" />
                                            </label></td>
                                          <td>&nbsp;</td>
                                        </tr>
                                        <tr>
