<?php
//llamamos el codigo de sesion para usuario nivel 3 = encargado de area
...
$base->execute_query("SELECT f.id_fuente AS id_fuente,
								...
								t.id_senal AS id_senal
					   FROM fuente AS f, fuente_tel as t
...
$fuente = new FuenteTV($base->get_row_assoc());
        ...
        <table width="1000" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr valign="top">
                        ...
                        <tr valign="middle">
                          ...
                          <td width="533" height="25" class="label2">Fuentes --&gt; Administrar Fuentes --&gt; <span class="label4">Ver Datos de Fuente de TV</span></td>
...
<table width="1000" border="0">
                        ...
                        <tr>
                            ...
                            <td valign="top"><table width="825" border="0" align="center">
                                    ...
                                    <tr>
                                        <td>&nbsp;</td>
                                        <td class="label2">Canal:</td>
                                        <td colspan="3" class="label1"><?php echo $fuente->get_canal();?></td>
                                    </tr>
                                    <tr>
                                        <td>&nbsp;</td>
                                    ...
                                    <tr>
                                        <td>&nbsp;</td>
                                        <td class="label2">Señal:</td>
                                      <td colspan="3" class="label1"><?php echo $fuente->get_senal_txt();?></td>
                                    </tr>
