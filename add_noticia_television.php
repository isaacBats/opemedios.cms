...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Agregar Noticia de Televisión - OPM</title>
        <style type="text/css">
            <!--
	...
	/*function valida_combo() {
		...
		//alert(combo1.value);
		if(combo1.value == 0) {
			alert("Porfavor, seleccione un valor de Tendencia");
			document.getElementById("col").style.border = "2px solid red";
			return false;
		} else {
			document.getElementById("col").style.border = "";
			return true;
		  }
	}*/
            ...
            <tr>
                <td width="505" valign="top" >
				    <table width="505" height="37" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            <td><img src="images/titulo_addnoticiatele.png" width="500" height="30"/></td>
                        </tr>
                    </table>
					...
					<table width="500" border="0" cellpadding="1" cellspacing="1">
                        ...
                        <table width="500" border="0" cellpadding="1" cellspacing="1">
                            <tr>
                                <td width="10">&nbsp;</td>
                                <td width="110" class="label1">Tipo de Autor:</td>
                                <td width="120"><select name="id_tipo_autor" class="combo1" id="id_tipo_autor">
                                        <?php
                                ...
                                <td width="10">&nbsp;</td>
                                <td width="110" class="label1">Sector:</td>
                                <td width="120"><select name="id_sector" class="combo1" id="id_sector">
                                        <?php
						...
						<table width="500" border="0" cellpadding="1" cellspacing="1">
                            ...
                            <tr id="col">
                                <td width="10">&nbsp;</td>								
                                <td width="150" class="label1">Tendencia:</td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td><textarea name="comentario" cols="45" rows="4" class="texboxML2" id="comentario"></textarea></td>
                                <td width="10">&nbsp;</td>
                            </tr>                            
                            <tr>
                                <td width="10">&nbsp;</td>
                                <td class="label1">Archivo de Video:</td>
                                <td><input name="archivo" type="file" class="textbox1" id="archivo" size="50" /></td>
                                <td>&nbsp;</td>
                            </tr>
                            <tr>
                                <td width="10">&nbsp;</td>                                
                                <td colspan="2"><input name="secundario" type="checkbox" id="secundario" value="yes" />
                            ...
                            <tr>
                                ...
                                <td><input name="insertar" type="hidden" id="insertar" value="true" />
                                    <input name="id_tipo_fuente" type="hidden" id="id_tipo_fuente" value="1" />
                                    <input name="id_usuario" type="hidden" id="id_usuario" value="<?php echo $current_user->get_id();?>" /></td>
                                <td><div align="center">
									<input name="enviar" type="submit" disabled id="enviar" onclick="MM_validateForm('encabezado','','R','autor','','R','costo','','NisNum','sintesis','','R','costo','','R');return document.MM_returnValue" value="Agregar Noticia"/>
                              </div></td>
                                <td width="10">&nbsp;</td>                               
                            </tr>                       
                        </table>
