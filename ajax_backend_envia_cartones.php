        ...
        case "muestra_cuentas":
            ...
            else // si hay cuentas
            {
                ...
                while($row_cuenta = $base->get_row_assoc())
                {
                    ...
                    $new_back[] .= '<form id="form1" name="form1" method="post" action="action_envia_cartones.php">';
                   
                    $new_back[] .= '<br />
                                    <span class="label2">Seleccionar cuentas a las que se enviarán los Cartones:</span><br /><br />
                    ...
                    $new_back[] .= '</table>
                                <br />
                                <div align="center">
                                  <input type="submit" name="sumbit" id="submit" value="Enviar Cartones" />
                                </div>
                              </form>
                            <br />';
                    $output = join("", $new_back);
