                ...
                <td width="1000" height="500" valign="top" background="images/images/BackGround_02bg.jpg"><table width="1000" border="0" cellpadding="0" cellspacing="0" background="images/images/BackGround_02.jpg">
                    ...
                    <table width="1000" border="0">
                        ...
                        <tr>
                            ...
                            <td valign="top"><form action="action_set_archivo_contenedor.php" method="post" enctype="multipart/form-data" name="form1" id="form1" onsubmit="disable()">
                      <table width="825" border="0">
                                        ...
                                        <tr>
                                            <td>&nbsp;</td>
                                            <td height="28" colspan="2" class="label2">Seleccione un archivo para establecerlo como pagina contenedora de esta noticia, el archivo debe pesar menos de 50Mb</td>
                                            <td>&nbsp;</td>
                                        </tr>
