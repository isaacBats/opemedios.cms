...
$base->execute_query("SELECT id_fuente, nombre FROM fuente WHERE id_tipo_fuente = 3 AND activo = 1 ORDER BY nombre");
...
<title>Agregar Noticia de Periodico - OPM</title>
<style type="text/css">
<!--
      ...
      if (val) { nm=val.name; if ((val=val.value)!="") {
        if (test.indexOf('isEmail')!=-1) { p=val.indexOf('@');
          ...
          if (test.indexOf('inRange') != -1) { p=test.indexOf(':');
            ...
            if (num<min || max<num) errors+='- '+nm+' el numero debe ser entre '+min+' y '+max+'.\n';
...
<table width="505" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td width="505" valign="top"><table width="505" height="37" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td><img src="images/titulo_addnoticia_periodico.png" width="500" height="30" /></td>
      </tr>
    </table>
      <form action="action_add_noticia.php" method="post" enctype="multipart/form-data" name="form1" target="_self" id="form1" onsubmit="disable()">
		...
		<table width="500" border="0" cellpadding="1" cellspacing="1">
              <tr>
                <td width="10">&nbsp;</td>
                <td width="90" height="25" class="label1">Tipo de Autor:</td>
                ...
                <td width="10">&nbsp;</td>
                <td width="90" class="label1">Sector:</td>
              ...
              <tr>
                <td>&nbsp;</td>
                <td colspan="5" class="label1">Noticia (Archivo JPG):<br><input name="archivo_noticia" type="file" class="textbox1" id="archivo_noticia" size="57" accept="image/jpeg" /></td>
                <td>&nbsp;</td>
              </tr>
              <tr>
                <td>&nbsp;</td>                
              ...
              <tr>
                ...
                <td colspan="5" class="label1">
					Página donde se encuentra la nota(Archivo JPG):<br><input name="archivo_pagina" type="file" class="textbox1" id="archivo_pagina" size="57" accept="image/jpeg"/>
				</td>
                <td>&nbsp;</td>
              </tr>
              <tr>
                ...
                <td colspan="5">
                  ...
                  <input name="id_tipo_fuente" type="hidden" id="id_tipo_fuente" value="3" />
