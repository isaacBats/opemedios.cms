...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Envio Resumen de Noticias</title>
        <style type="text/css">
            <!--
            body {
            ...
            function MM_preloadImages() { //v3.0
                ...
                function BuscaCliente() {
                    if (div_clientes_Req.readyState == 4 || div_clientes_Req.readyState == 0)
                    {
                        ...
                        div_clientes_Req.open("POST", 'ajax_backend_envio_resumen_noticias.php?action=busca_cliente', true);
                ...
                function SeleccionaCliente(id_cliente)
                {
                    ...
                    {
                        document.getElementById('div_clientes').innerHTML = '<span class="label2">Cargando...<img src="images/working.gif" /></span>';
                        div_clientes_Req.open("POST", 'ajax_backend_envio_resumen_noticias.php?action=get_info_cliente', true);
                        div_clientes_Req.setRequestHeader('Content-Type','application/x-www-form-urlencoded');
                ...
                function handleContentTema(id_noticia) {
                    if (div_tema_Req.readyState == 4) {
                        var text_div = document.getElementById('div_tema_'+id_noticia);
                        var content = div_tema_Req.responseText;
                        text_div.innerHTML = content;
                    }
                }
                function handleContentTendencia(id_noticia) {
                    if (div_tendencia_Req.readyState == 4) {
                        var text_div = document.getElementById('div_tendencia_'+id_noticia);
                        var content = div_tendencia_Req.responseText;
                        text_div.innerHTML = content;
                    }
                }
                function handleContentBoton(id_noticia) {
                    if (div_boton_Req.readyState == 4) {
                        var text_div = document.getElementById('div_boton_'+id_noticia);
                ...
                function modificaNoticia(id_not,id_emp,id_tem,id_ten)
                {
                    if(div_tema_Req.readyState == 4 || div_tema_Req.readyState == 0)
                    {
                        ...
                        setTimeout("handleContentTema("+id_not+")",2700);
                    ...
                    if(div_tendencia_Req.readyState == 4 || div_tendencia_Req.readyState == 0)
                    {
                        ...
                        setTimeout("handleContentTendencia("+id_not+")",2700);
                    }
                    ...
                    if(div_boton_Req.readyState == 4 || div_boton_Req.readyState == 0)
                    {
                        ...
                        setTimeout("handleContentBoton("+id_not+")",2700);
                    }
                ...
                function ActualizaNoticia(id_not,id_emp,id_tem,id_ten)
                {
                    if(http_Req.readyState == 4 || http_Req.readyState == 0)
                    {
                        ...
                        param+= '&id_tendencia=' + id_ten;
                        http_Req.send(param);
                        document.getElementById('actualizar_'+id_not).value = 'Modificando...';
                        document.getElementById('actualizar_'+id_not).disabled = true;
                        setTimeout("handleActualiza("+id_not+")",2700);
                    }
                }
                function handleActualiza(id_not)
                {
                    if (http_Req.readyState == 4) {
                        var content = div_boton_Req.responseText;
                        if(content == 'exito')
                        {
                            document.getElementById('actualizar_'+id_not).value = 'Modificado';
                            document.getElementById('id_tendencia_'+id_not).disabled = true;
                            document.getElementById('id_tema_'+id_not).disabled = true;
                        }
                        else
                        {
                            document.getElementById('actualizar_'+id_not).value = 'Error';
                            document.getElementById('id_tendencia_'+id_not).disabled = true;
                            document.getElementById('id_tema_'+id_not).disabled = true;
                        }
            ...
            <tr>
                <td width="1000" height="500" valign="top" background="images/images/BackGround_02bg.jpg"><table width="1000" border="0" cellpadding="0" cellspacing="0" background="images/images/BackGround_02.jpg">
                        ...
                        <tr valign="middle">
                            ...
                            <td width="533" height="25" class="label2">Noticias --&gt; <span class="label4">Envio de Noticias a Clientes</span></td>
                    ...
                    <table width="1000" border="0">
                        <tr>
                            <td width="15">&nbsp;</td>
                            <td width="485" valign="top"><table width="480" border="0">
                                    <tr>
                                        <td width="244"></td>
                                        <td width="226"></td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td class="label2">Seleccione Fecha:</td>
                                        <td class="label2">Buscar Cliente:</td>
                                    </tr>
                                    <tr>
                                        <td valign="top" class="label2">De:<br /><script>DateInput('fecha1', true, 'DD-MON-YYYY')</script>A:<br /><script>DateInput('fecha2', true, 'DD-MON-YYYY')</script></td>
                                        <td valign="top" class="label2"><br /><input name="txt_busca_cliente" type="text" class="textbox2" id="txt_busca_cliente" />
                                            <br />
                                        <p align="center"><input type="submit" name="buscar" id="buscar" value="Buscar -&gt;" onclick="BuscaCliente()"/></p></td>
                                    </tr>

                            </table></td>
                            <td width="486" valign="top"><table width="480" border="0">
                                    <tr>
                                        <td>&nbsp;</td>
                                    </tr>
                                    <tr>
