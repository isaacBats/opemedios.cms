...
$hora = intval(date("G",mktime(substr($noticia->getHora_publicacion(),0,2),0,0,1,1,2000)));
$minuto  = intval(date("i",mktime(0,substr($noticia->getHora_publicacion(),3,2),0,1,1,2000)));
$segundo = intval(date("s",mktime(0,0,substr($noticia->getHora_publicacion(),6,2),1,1,2000)));
                ...
                <td width="1000" height="500" valign="top" background="images/images/BackGround_02bg.jpg"><table width="1000" border="0" cellpadding="0" cellspacing="0" background="images/images/BackGround_02.jpg">
                    ...
                    <table width="1000" border="0">
                        ...
                        <tr>
                            ...
                            <td valign="top"><form id="form1" name="form1" method="post" action="action_edit_noticia_internet.php">
								<table width="825" border="0">
                                        ...
                                        <tr>
											...
											<td>
												<label><textarea name="sintesis" cols="45" rows="5" class="texboxML2" id="sintesis"><?php echo $noticia->getSintesis();?></textarea></label>
											</td>
                                            <td>&nbsp;</td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td>&nbsp;</td>
                                            <td class="label3">Nombre Autor:</td>
                                            <td><label>
                                        ...
                                        <tr>
                                            <td>&nbsp;</td>
                                            <td class="label3">URL:</td>
											<td><label><textarea name="url" cols="45" rows="5" class="texboxML" id="url"><?php echo $noticia->getUrl(); ?></textarea></label></td>
											<td>&nbsp;</td>
                                        </tr>
