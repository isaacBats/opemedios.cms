                            ...
                            <td valign="top">
                                ...
                                <table width="825" border="3" align="center" cellpadding="0" cellspacing="0">
                                    <tr class="header2">
                                      ...
                                      <td><div align="center"><a href="admin_fuentes.php?orden=0">Nombre</a></div></td>
                                        <td><div align="center"><a href="admin_fuentes.php?orden=1">Empresa</a></div></td>
                                    ...
                                    foreach ($arreglo_fuentes as  $fe) {
                                        ...
                                        echo'<td widht="32" ><img src="images/icons/'.$fe->get_id_tipo_fuente().'.png" width = "32" height="32"></td>';
                                        echo'<td><div align="center">'.$fe->get_nombre().'</div></td>';
                                        echo'<td><div align="center">'.$fe->get_empresa().'</div></td>';
                                        echo'<td widht="127"><img src="data/fuentes/'.$fe->get_logo().'" width ="127" height="80"></td>';
