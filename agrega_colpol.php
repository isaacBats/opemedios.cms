        ...
        <table width="1000" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr valign="top">
                        ...
                        <tr valign="middle">
                          ...
                          <td width="533" height="25" class="label2">Prensa --&gt; Columnas Politicas--&gt;<span class="label4"> Agregar</span></td>
...
<table width="1000" border="0">
                        ...
                        <td valign="top"><form action="action_add_colpol.php" method="post" enctype="multipart/form-data" name="form_insert" id="form_insert">
                              <table width="825" border="0">
                                <tr>
                                  <td width="96">&nbsp;</td>
                                  <td width="157" class="label2"><span class="label2">Agregar Columnas Politicas</span></td>
                                ...
                                <tr>
                                  ...
                                  <td class="label3">Contenido:</td>
                                   <td><textarea name="contenido" cols="70" rows="20" class="inputs"></textarea></td>
                                  <td>&nbsp;</td>
                                </tr>
                                <tr>
                                  <td>&nbsp;</td>
