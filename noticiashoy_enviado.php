...
function GetSQLValueString($theValue, $theType, $theDefinedValue = "", $theNotDefinedValue = "") 
{
  ...
  $theValue = function_exists("mysql_real_escape_string") ? mysql_real_escape_string($theValue,$bitacora) : mysql_escape_string($theValue);
...
$query_noticias = "SELECT    noticia.id_noticia AS Clave,   noticia.encabezado AS Encabezado,   noticia.fecha AS Fecha,   noticia.id_tipo_fuente AS TipoFuente,   fuente.nombre AS NombreFuente,   fuente.logo AS LogoFuente,   seccion.nombre AS NombreSeccion FROM  noticia  INNER JOIN fuente ON (noticia.id_fuente=fuente.id_fuente)  INNER JOIN seccion ON (noticia.id_seccion=seccion.id_seccion) WHERE   noticia.fecha = CURDATE() ";
        ...
        <table width="1000" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr>
                <td width="1000" height="500" valign="top" background="images/images/BackGround_02bg.jpg"><table width="1000" border="0" cellpadding="0" cellspacing="0" background="images/images/BackGround_02.jpg">
                        <tr>
                            <td height="25" colspan="3" valign="top"><?php include("includes/mainmenu.php");?></td>
                        </tr>
                        <tr>
                            <td width="15" height="25">&nbsp;</td>
                            <td width="533" height="25" valign="middle" class="label2">Noticias --&gt; <span class="label4">Noticias de Hoy</span></td>
                            <td width="452" height="25" valign="middle"><span class="label2">Bienvenido:</span> <span class="label1"><?php echo $current_user->get_nombre_completo();?></span></td>
                        </tr>
                    </table>
                    <table width="1000" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                            <td valign="top"><table width="152" border="0" align="center" cellpadding="0" cellspacing="0">
                                    <tr>
                            ...
                            <td valign="top"><table width="825" border="3" cellpadding="0" cellspacing="0">
                              <tr class="header2">
                                  ...
                                  <td><div align="center">Noticia&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="noticiashoy_up.php"><img src="images/up_flecha.png" width="20" height="18"/></a><a href="noticiashoy.php"><img src="images/down_flecha.png" width="32" height="18" /></a></div></td>
                                  <td><div align="center">Fuente&nbsp;&nbsp;&nbsp;<a href="noticiashoy_fuente_up.php"><img src="images/up_flecha.png" width="20" height="18"/></a><a href="noticiashoy_fuente.php"><img src="images/down_flecha.png" width="32" height="18" /></a></div></td>
                                  <td><div align="center">Enviado a:&nbsp;&nbsp;&nbsp;<a href="noticiashoy_enviado_up.php"><img src="images/up_flecha.png" width="20" height="18"/></a><a href="noticiashoy_enviado.php"><img src="images/down_flecha.png" width="32" height="18" /></a></div></td>
								...
								if(mysql_num_rows($noticias) > 0)
								{
									$base->execute_query("SELECT
														...
														WHERE asigna.id_noticia = ".$row_noticias['Clave']. " ORDER BY nombre_empresa DESC");
									if($base->num_rows() > 0)
									{
								...
								?>
                                  ...
                                  <tr class="label2">
                                    <td><div align="center"><img name="icon" src="images/icons/<?php echo $row_noticias['TipoFuente']; ?>.png" /><span class="label5"><br />
                                    </span></div></td>
...
Registros <?php echo ($startRow_noticias + 1) ?> - <?php echo min($startRow_noticias + $maxRows_noticias, $totalRows_noticias) ?> de <?php echo $totalRows_noticias ?> <br />
<table border="0">
  <tr>
