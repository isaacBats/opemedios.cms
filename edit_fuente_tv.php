...
$base->execute_query("SELECT * FROM fuente_tel WHERE id_fuente =".$_GET['id_fuente']);
$datos_fuente2 = $base->get_row_assoc();

$datos = $datos_fuente1 + $datos_fuente2;

//creamos el objeto FuenteTV con los datos que nos regrese la consulta
$fuente = new FuenteTV($datos);
        ...
        <table width="1000" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr valign="top">
                        ...
                        <tr valign="middle">
                          ...
                          <td width="533" height="25" class="label2">Fuentes --&gt; Administrar Fuentes --&gt; <span class="label4">Editar Fuente de TV</span></td>
...
<table width="1000" border="0">
                        ...
                        <tr>
                            ...
                            <td valign="top"><form id="form_update" name="form_update" method="post" action="action_edit_fuente_tv.php">
                                    <table width="825" border="0">
                                        ...
                                        <tr>
                                            ...
                                            <td><label>
                                              <input name="conductor" type="text" class="textbox1" id="conductor" value="<?php echo $fuente->get_conductor();?>" />
                                            </label></td>
                                          <td>&nbsp;</td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td><label>
                                              <input name="canal" type="text" class="textbox1" id="canal" value="<?php echo $fuente->get_canal();?>" />
                                            </label></td>
                                          <td>&nbsp;</td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td><label>
                                              <input name="horario" type="text" class="textbox1" id="horario" value="<?php echo $fuente->get_horario();?>" />
                                            </label></td>
                                          <td>&nbsp;</td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td><label>
 											...
 											<?php
                                                 ...
                                                 {
                                            	     echo '<option value="'.$value.'"'; if($value == $fuente->get_id_senal()){echo 'selected="selected"';}  echo'>'.utf8_encode($label).'</option>';
                                                 }
                                             ?>
                                              </select>
                                            </label></td>
