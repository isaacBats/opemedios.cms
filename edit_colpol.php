...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Editar Columna Politica</title>
        <style type="text/css">
            <!--
            body {
        ...
        <table width="1000" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr valign="top">
                        ...
                        <tr valign="middle">
                          ...
                          <td width="533" height="25" class="label2">Prensa --&gt; Columnas Politicas--&gt;<span class="label4"> Editar</span></td>
...
<table width="1000" border="0">
                        ...
                        <td valign="top"><form action="action_add_colpol.php" method="post" enctype="multipart/form-data" name="form_insert" id="form_insert">
                              <table width="825" border="0" bordercolor="#000000">
                                <tr>
                                  <td width="93">&nbsp;</td>
                                  <td width="153" class="label2"><span class="label2">Editar Columnas Politicas</span></td>
                                  <td width="530">&nbsp;</td>
                                  <td width="21">&nbsp;</td>
                                </tr>
                                <tr>
                        ...
                        <tr>
                            <td><form action="action_add_colpol.php" method="post" enctype="multipart/form-data" name="form_insert" id="form_insert">
                              <table width="1000" border="0">
                                <tr>
