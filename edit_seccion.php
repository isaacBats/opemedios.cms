        ...
        <table width="1000" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr valign="top">
                        ...
                        <tr valign="middle">
                          ...
                          <td width="533" height="25" class="label2">Fuentes --&gt; Administrar Fuentes --&gt; <span class="label4">Editar Sección</span></td>
                        ...
                        <tr>
                            ...
                            <td valign="top"><table width="825" border="0">
                              <tr>
                                ...
                                <td width="400"><img src="<?php echo "data/fuentes/".$fuente->get_logo(); ?>" alt="" name="logo" width="127" height="80" id="logo" /></td>
                                <td width="22">&nbsp;</td>
                              </tr>
                              
                              
                            </table>
                              <form id="form_edit_seccion" name="form_edit_seccion" method="post" action="action_edit_seccion.php">
                                <table width="825" border="0">
                                  <tr>
                                    <td width="35">&nbsp;</td>
                                    <td width="171" class="label2">Editar Sección:</td>
                                    <td width="359">&nbsp;</td>
                                    <td width="242">&nbsp;</td>
                                  </tr>
                                  <tr>
                                    <td><input name="id_seccion" type="hidden" id="id_seccion" value="<?php echo $seccion->get_id(); ?>" /></td>
                                    <td>&nbsp;</td>
                                    <td>&nbsp;</td>
                                    <td>&nbsp;</td>
                                  </tr>
                                  <tr>
                                    ...
                                    <td><label>
                                            <input name="nombre" type="text" class="textbox1" id="nombre" value="<?php echo $seccion->get_nombre();?>" />
                                    </label></td>
                                    <td>&nbsp;</td>
                                  </tr>
                                  <tr>
                                    ...
                                    <td><label>
                                            <textarea name="descripcion" cols="45" rows="5" class="texboxML" id="descripcion"><?php echo $seccion->get_descripcion();?></textarea>
                                    </label></td>
                                    <td>&nbsp;</td>
                                  </tr>
                                  <tr>
                                    ...
                                    <td><label>
                                      <input name="activo" type="checkbox" id="activo" value="1" <?php if ($seccion->get_activo() == 1) {echo "checked=\"checked\"";} ?>/>
                                    </label></td>
                                    <td>&nbsp;</td>
                                  </tr>
                                  <tr>
                                    ...
                                    <td>&nbsp;</td>
                                    <td>&nbsp;</td>
                                    <td><input name="button" type="submit" id="button" onclick="MM_validateForm('nombre','','R','descripcion','','R');return document.MM_returnValue" value="Editar Sección" /></td>
                                  </tr>
                                </table>
                              </form>
                          </td>
