...
<head>
	...
	<title>Opemedios - @yield('title', 'Operadora de Medios Informativos 2016')</title>
		
	<!-- Bootstrap Core CSS -->
    <link href="/resources/assets/bower_components/bootstrap/dist/css/bootstrap.min.css" rel="stylesheet">

    <!-- MetisMenu CSS -->
    <link href="/resources/assets/bower_components/metisMenu/dist/metisMenu.min.css" rel="stylesheet">

    <!-- Custom CSS -->
    <link href="/resources/assets/css/sb-admin-2.css" rel="stylesheet">

    <!-- Custom Fonts -->
    <link href="/resources/assets/bower_components/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css">
