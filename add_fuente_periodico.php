            ...
            <tr>
                <td width="1000" height="500" valign="top" background="images/images/BackGround_02bg.jpg"><table width="1000" border="0" cellpadding="0" cellspacing="0" background="images/images/BackGround_02.jpg">
                        ...
                        <tr valign="middle">
                            ...
                            <td width="533" height="25" class="label2">Fuentes --&gt; Agregar Fuente --&gt; <span class="label4"> Periódico</span></td>
                    ...
                    <form action="action_add_fuente_periodico.php" method="POST" name="form_inserta" id="form_inserta">
                  <table width="1000" border="0" cellspacing="0" cellpadding="0">
                                ...
                                <td valign="top"><table width="450" border="0" cellspacing="0" cellpadding="0">
                                        ...
                                        <tr>
                                            ...
                                            <td height="25" class="label3"><label>
                                              <input name="tiraje" type="text" class="textbox1" id="tiraje" />
                                            </label></td>
                                  </tr>
                                        <tr>
                            ...
                            <tr>
                                ...
                                <td>&nbsp;</td>
                                <td><div align="right">
                                        <input name="button" type="submit" id="button" onclick="MM_validateForm('nombre','','R','empresa','','R','tiraje','','RisNum');return document.MM_returnValue" value="Agregar Fuente" />
                                </div></td>
                                <td>&nbsp;</td>
                            </tr>
                        </table>
