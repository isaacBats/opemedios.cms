                    ...
                    <table width="95%" border="0">
						<tr>
							...
							<td colspan="2">
								...
								<tr align="center"><td colspan="2">Envió de Bloque de Noticias</td></tr>
								<?php 
								for ($i=0;$i<25;$i++) {
									echo '<tr>
										<td>Número de Noticia:</td>
										<td>&nbsp;<input type="text" name="id_noticia" value="" maxlength="6" size="8"></td>
										</tr>';
										/*<td>Tipo de Noticia:</td>
										<td>
											<select name="id_tipo_fuente">
