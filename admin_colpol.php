...
$limite = paginacion_init($_GET["pagina"],$registros);
    ...
    $query = "SELECT * FROM columna_politica where fecha = '".$_GET['txt_buscar']."'";
...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Administrar Columnas Politicas</title>
        <style type="text/css">
            <!--
            body {
    ...
    <body>
        <table width="1000" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr valign="top">
                  ...
                  <form id="form_buscar" name="form_buscar" method="get" action="admin_colpol.php">         
...
<tr>
                                            ...
                                            <tr>
                                              <td width="18">&nbsp;</td>
                                              <td colspan="2" class="label2">Ver Columnas Politica por Fecha:</td>
                                              <td width="542">&nbsp;</td>
                                            </tr>
                                            <tr>
                                              <td>&nbsp;</td>
                          ...
                          <tr class="header2">
                            ...
                            <td width="124">&nbsp;</td>
                                    ...
                                    while($row_query = $base->get_row_assoc())
                                    {
                                            ...
                                            echo'<td align="center"><a href="edit_colpol.php?id_pp='.$row_query['id'].'">Editar Columna</a></td>';
                                            echo'</tr>';
                                        }
                                    ?>
                              </table> 
