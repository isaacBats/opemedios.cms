        ...
        <table width="1000" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr valign="top">
                        ...
                        <tr valign="middle">
                          ...
                          <td width="533" height="25" class="label2"> Reportes  --&gt;<span class="label4"> Noticias Por Clientes</span></td>
...
<table width="1000" border="0">
                        ...
                        <tr>
                            <td valign="top"><form id="form_buscar" name="form_buscar" method="get" action="reporte_noticia_cliente_xls.php">
                              <table width="152" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr>
                                  <td height="28" background="images/images/menusec_01_busqueda.png">&nbsp;</td>
                                </tr>
                                <tr>
                                  <td height="55" align="center" valign="middle" background="images/images/menusec_02_empty.png"><label> Cliente<br />
                          ...
                          <tr class="header2">
                            ...
                            <td width="62">&nbsp;</td>
                                    ...
                                    while($row_query = $base->get_row_assoc())
                                    {
                                            echo'<tr class="label1"><form name="reporte" action="busqueda_avanzada_reportes_xls.php" method="POST">';
					    ...
					    echo'<td><div align="center">'.$row_query['giro'].'</div></td>';
                                           ...
                                           // echo'<td><div align="center"><script>DateInput("fecha_fin", true, "YYYY-MM-DD") </script></div></td>';
                                            echo'<td align="center"><input type="submit" value="Reporte" name="Reporte" /></td>';
