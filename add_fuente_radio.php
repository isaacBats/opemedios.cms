            ...
            <tr>
                <td width="1000" height="500" valign="top" background="images/images/BackGround_02bg.jpg"><table width="1000" border="0" cellpadding="0" cellspacing="0" background="images/images/BackGround_02.jpg">
                        ...
                        <tr valign="middle">
                            ...
                            <td width="533" height="25" class="label2">Fuentes --&gt; Agregar Fuente --&gt; <span class="label4"> Radio</span></td>
                    ...
                    <form action="action_add_fuente_radio.php" method="POST" name="form_inserta" id="form_inserta">
                  <table width="1000" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                ...
                                <td valign="top"><table width="450" border="0" cellspacing="0" cellpadding="0">
                                        ...
                                        <tr>
                                            <td height="28" class="label3">Estacion:</td>
                                            <td height="25" class="label3"><label>
                                                    <input name="estacion" type="text" class="textbox1" id="estacion" />
                                            </label></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                          ...
                                          <td height="25" class="label3"><label></label></td>
                                        </tr>
                                </table></td>
                                <td valign="top">&nbsp;</td>
                                <td valign="top"><table width="450" border="0" cellspacing="0" cellpadding="0">
