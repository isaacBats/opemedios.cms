...
if ($numero_rows > 0) {
	$row_sector = $base->get_row_assoc();
	$nombre_sector = $row_sector["nombre"];
	$base->execute_query("DELETE FROM sector WHERE id_sector = '".$id_sector."'");	
}
...
<table width="1000" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr valign="top">
                        ...
                        <tr valign="middle">
                          ...
                          <td width="533" height="25" class="label2">Sector --&gt; <span class="label4">Administrar Sector</span></td>
                        ...
                        <tr>
							...
							<td valign="top">                               
                                <table width="800" border="3" align="center" cellpadding="0" cellspacing="0">
                                    <tr class="header2">
                                        <td width="32">Eliminación de Sector</td>
									</tr>
									<tr>
                                        <td width="32">&nbsp;</td>
									</tr>
									<tr>
                                        <td width="32">El Sector <b><?php echo $nombre_sector; ?></b> se elimino con éxito</td>
									</tr>									
                                </table>                                
							</td>
                        </tr>
