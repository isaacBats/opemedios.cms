...
$limite = paginacion_init($_GET["pagina"],$registros);
    ...
    $query = "SELECT * FROM carton where fecha = '".$_GET['txt_buscar']."'";
        ...
        <table width="1000" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr valign="top">
                        ...
                        <tr valign="middle">
                          ...
                          <td width="533" height="25" class="label2">Prensa --&gt; Cartones --&gt;<span class="label4"> Administrar Cartones</span></td>
...
<table width="1000" border="0">
                        ...
                        <tr>
                            <td valign="top"><form id="form_buscar" name="form_buscar" method="get" action="admin_cartones.php">
                              <table width="152" border="0" align="center" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                  <td height="55" align="center" valign="middle" background="images/images/menusec_02_empty.png"><label>
                                     <script>DateInput('txt_buscar', true, 'YYYY-MM-DD',<?php if(isset($_GET['txt_buscar'])){echo "'".$_GET['txt_buscar']."'"; }else{echo "'".date("Y-m-d" ,time())."'";}?>) </script>
                                    <br />
                          ...
                          <tr class="header2">
                            ...
                            <td width="62">&nbsp;</td>
                                    ...
                                    while($row_query = $base->get_row_assoc())
                                    {
                                            ...
                                            echo'<td widht="32" align="center" ><img height="200" width="150" src="data/cartones/'.$row_query['imagen'].'"></td>';
                                            echo'<td align="center"><a href="enviar_carton.php?id_pp='.$row_query['id'].'">Enviar a Cliente</a></td>';
                                            echo'<td align="center"><a href="edit_carton.php?id_pp='.$row_query['id'].'">Editar Carton</a></td>';
                                            echo'</tr>';
                                        }
                                    ?>
                                </table> 
