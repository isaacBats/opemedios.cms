    ...
    <body>
        <table width="1000" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr valign="top">
                  ...
                  <form id="form_buscar" name="form_buscar" method="get" action="admin_cartones.php">         
...
<tr>
                                            ...
                                            <tr>
                                              <td width="18">&nbsp;</td>
                                              <td colspan="2" class="label2">Ver Cartones por Fecha:</td>
                                              <td width="542">&nbsp;</td>
                                            </tr>
                                            <tr>
                                              <td>&nbsp;</td>
                                              ...
                                              <td><input name="btnbuscar" type="submit" id="btnbuscar" value="Ver Cartones" /></td>
                                            </tr>
                                          </table>
                  </form>
