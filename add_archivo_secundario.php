...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Agregar Archivo Secundario</title>
        <style type="text/css">
            <!--
            body {
            ...
            <tr>
                <td width="1000" height="500" valign="top" background="images/images/BackGround_02bg.jpg"><table width="1000" border="0" cellpadding="0" cellspacing="0" background="images/images/BackGround_02.jpg">
                        ...
                        <tr valign="middle">
                            ...
                            <td width="533" height="25" class="label2">Noticias --&gt; <span class="label4">Agregar Archivo Secundario</span></td>
                    ...
                    <table width="1000" border="0">
                        ...
                        <tr>
                            ...
                            <td valign="top"><form action="action_add_archivo_secundario.php" method="post" enctype="multipart/form-data" name="form1" id="form1" onsubmit="disable()">
                      <table width="825" border="0">
                                        ...
                                        <tr>
                                            <td>&nbsp;</td>
                                            <td height="28" colspan="2" class="label2">Seleccione un archivo para añadirlo como archivo secundario a esta noticia, el archivo debe pesar menos de 50Mb</td>
                                            <td>&nbsp;</td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td><div align="right">
                                                    <label></label>
                                                    <label>
                                                        <input type="submit" name="enviar" id="enviar" value="Agregar Archivo" />
                                                    </label>
                                            </div></td>
                                            <td>&nbsp;</td>
                                        </tr>
