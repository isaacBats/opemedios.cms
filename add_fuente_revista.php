            ...
            <tr>
                <td width="1000" height="500" valign="top" background="images/images/BackGround_02bg.jpg"><table width="1000" border="0" cellpadding="0" cellspacing="0" background="images/images/BackGround_02.jpg">
                        ...
                        <tr valign="middle">
                            ...
                            <td width="533" height="25" class="label2">Fuentes --&gt; Agregar Fuente --&gt; <span class="label4"> Revista</span></td>
                    ...
                    <form action="action_add_fuente_revista.php" method="POST" name="form_inserta" id="form_inserta">
