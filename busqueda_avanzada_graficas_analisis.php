        ...
        <table width="1000" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr valign="top">
                        ...
                        <tr valign="middle">
                          ...
                          <td width="533" height="25" class="label2">Gráficas --&gt; Clientes --&gt; <span class="label4">Parámetros de Graficación</span></td>
...
<table width="1000" border="0">
              ...
              <form id="form2" name="form2" method="GET" action="graficas_analisis.php">
                <table width="1000" border="0">
                  <tr>
                    <td width="47">&nbsp;</td>
                    <td width="94">&nbsp;</td>
                  ...
                  <tr>
                    ...
                    <td><div align="center">
                      <label>
                      <input type="submit" name="buscar2" id="buscar2" value="Graficar" />
                      </label>
                    </div></td>
                  </tr>
                  <tr>
