...
$sql = 'SELECT * FROM cuesta_electronico WHERE id_fuente = '.$noticia->getId_fuente().' AND id_horario = '.$horarioid.' AND id_mes = '.$idmes.' ORDER BY id_mes, id_horario';
                        ...
                        <tr>
                            ...
                            <td valign="top"><table width="825" border="0">
                                    <tr>
                                        ...
                                        <td width="384" valign="top" class="label2">Costo beneficio: <span class="label5">$ <?php echo number_format($noticia->getCosto()) ?></span><br />
