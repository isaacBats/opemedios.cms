...
require("phpclasses/ColumnaFinanciera.php");
...
$url = "data/col_fin"; // donde se copian los documentos en el servidor
$urlpdf = "data/col_fin/pdf";
...
if($mensaje == "exito")
{
    ...
    $pPlana = new ColumnaFinanciera($datos);
...
$base->close();
header("Location: agrega_colfin.php?&error_upload=".$error_upload."&mensaje=".$mensaje);
}
/****************************************************************************
 *
...
echo $query = "SELECT * FROM columna_financiera WHERE id_columna_financiera =".$row_id." LIMIT 1;";

$base->execute_query($query);
$pPlana = new ColumnaFinanciera($base->get_row_assoc());
$mensaje = "exito";
...
$base->close();
header("Location: edit_colfin.php?id_pp=".$row_id."&error_upload=".$error_upload."&mensaje=".$mensaje);
}
/****************************************************************************
 *
...
$query = "SELECT * FROM columna_financiera WHERE id_columna_financiera =".$row_id." LIMIT 1;";
...
$base->close();
header("Location: edit_colfin.php?id_pp=".$row_id."&error_upload=".$error_upload."&mensaje=".$mensaje." imagen");
}
/****************************************************************************
 *
...
$base->close();
header("Location: edit_colfin.php?id_pp=".$row_id."&error_upload=".$error_upload."&mensaje=".$mensaje." archivo");
}
