...
//hacemos consulta para la creacion del objeto FuenteExtra de internet
$base->execute_query("SELECT f.id_fuente AS id_fuente,
							 ...
							 t.url AS url
					   FROM fuente AS f, fuente_int as t
					   WHERE (f.id_fuente = ".$_GET['id_fuente']." AND f.id_fuente = t.id_fuente);");
					   
//creamos el objeto FuenteExtra con los datos que nos regrese la consulta, tambien indicando que es de tipo 5 = internet
	$fuente = new FuenteExtra($base->get_row_assoc(),5);

					   

//hacemos consulta para obtener las secciones  de la fuente
//por cada seccion que obtengamos generamos un objeto Seccion y lo asignamos al objeto FuenteExtra
        ...
        <table width="1000" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr valign="top">
                        ...
                        <tr valign="middle">
                          ...
                          <td width="533" height="25" class="label2">Fuentes --&gt; Administrar Fuentes --&gt; <span class="label4">Ver Datos de Fuente de Internet</span></td>
...
<table width="1000" border="0">
                        ...
                        <tr>
                            ...
                            <td valign="top"><table width="825" border="0" align="center">
                                    ...
                                    <tr>
                                        <td>&nbsp;</td>
                                        <td class="label2">URL:</td>
                                      <td colspan="3" class="label1"><?php echo $fuente->get_url();?></td>
                              </tr>
