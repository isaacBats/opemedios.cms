...
if ($orden == "1") {
$query_fuentes = sprintf("SELECT * FROM fuente WHERE (nombre LIKE %s OR empresa LIKE %s ) ORDER BY empresa", GetSQLValueString("%".$parametro."%", "text"),GetSQLValueString("%".$parametro."%", "text"));
}
else {
