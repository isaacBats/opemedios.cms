<?php
/* 
 * Action para agregar una nueva fuente de radio al sistema. recoje datos del formulario y
 * llama a la stored function  NEW_FUENTE_RADIO, despues manda a la pagina ver_fuente_radio.php donde se puede continuar
...
$nueva_fuente = new FuenteRadio($datos_fuente);
...
if($base->init()!=0)
{
    ...
    if($base->execute_query($nueva_fuente->SQL_NEW_FUENTE_RADIO())!=0)
    {
        ...
        //terminamos. ahora redireccionamos a la siguiente pantalla: ver_fuente_radio.php
        header("Location: ver_fuente_radio.php?id_fuente=".$nueva_fuente->get_id());
        exit ();
    }
    else
    {
