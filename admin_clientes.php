...
include("phpdelegates/paginacion_clientes.php");
        ...
        <table width="1000" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr valign="top">
                        ...
                        <tr valign="middle">
                          ...
                          <td width="533" height="25" class="label2">Clientes --&gt; <span class="label4">Administrar Clientes</span></td>
...
<table width="1000" border="0">
                        ...
                        <tr>
                            <td valign="top"><form id="form_buscar" name="form_buscar" method="get" action="admin_clientes.php">
                      <table width="152" border="0" align="center" cellpadding="0" cellspacing="0">
                            ...
                            <td valign="top">
                                ...
                                <table width="825" border="3" align="center" cellpadding="0" cellspacing="0">
                                    ...
                                    <?php
                                    foreach ($arreglo_empresas as  $re) {
                                        echo'<tr class="label1">';
                                        echo'<td><div align="center">'.$re->get_nombre().'</div></td>';
                                        echo'<td><div align="center">'.$re->get_contacto().'</div></td>';
                                        echo'<td><div align="center">'.$re->get_giro().'</div></td>';
                                        echo'<td><div align="center" class="label2"><a href="ver_cliente.php?id_empresa='.$re->get_id().'">Ver o Editar</a></div></td>';
                                        echo'</tr>';
                                    }
                                    ?>
                                </table>
