...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Agregar Col Financiera</title>
        <style type="text/css">
            <!--
            body {
        ...
        <table width="1000" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr valign="top">
                        ...
                        <tr valign="middle">
                          ...
                          <td width="533" height="25" class="label2">Prensa --&gt; Columnas Financieras--&gt;<span class="label4"> Agregar</span></td>
...
<table width="1000" border="0">
                        ...
                        <td valign="top"><form action="action_add_colfin.php" method="post" enctype="multipart/form-data" name="form_insert" id="form_insert">
                              <table width="825" border="0">
                                <tr>
                                  <td width="96">&nbsp;</td>
                                  <td width="157" class="label2"><span class="label2">Agregar Columnas Financieras</span></td>
                                ...
                                <tr>
                                  <td>&nbsp;</td>
                                  <td align="right" class="label3">Fecha:</td>
                                <td><label>
                                ...
                                <tr>
                                  <td>&nbsp;</td>
                                  <td align="right" class="label3">Titulo:</td>
                                  <td><input name="titulo" class="combo3"type="text" /></td>
                                  <td>&nbsp;</td>
                                </tr>
                                <tr>
                                  <td>&nbsp;</td>
                                  <td align="right" class="label3">Autor:</td>
                                  <td><input name="autor" class="combo3"type="text" /></td>
                                  <td>&nbsp;</td>
                                </tr>
                                <tr>
                                  <td>&nbsp;</td>
                                  <td align="right" class="label3">Contenido:</td>
                                  <td><textarea name="contenido" id="contenido" cols="45" rows="5"></textarea></td>
                                  <td>&nbsp;</td>
                                </tr>
                                <tr>
                                  <td>&nbsp;</td>
                                  <td align="right" class="label3">Fuente:</td>
                                <td><label>
                                ...
                                <tr>
                                  <td>&nbsp;</td>
                                  <td align="right" class="label3">Archivo:</td>
                                  <td valign="middle">
                                  <input colspan="4"  name="archivo_pdf" type="file" id="imagen" size = "45" />                                  </td>
                                  <td>&nbsp;</td>
                                </tr>
                                <tr>
                                  <td height="22">&nbsp;</td>
                                  <td align="right" class="label3">Imagen: <br></td>
                                  <td valign="middle">
                                  <input colspan="4"  name="imagen_jpg" type="file" id="imagen" size = "45" />                                  </td>
                                  <td> &nbsp; &nbsp; <br></td>
                                </tr>
                                <tr>
                                   <tr>
